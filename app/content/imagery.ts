...
export const imagery = {
  ...
  homeFounderPathway: asset({
    base: `${imageryRoot}/pathways/pathway-home-founder`,
    mobileBase: `${imageryRoot}/mobile/pathway-home-founder-mobile`,
    widths: [480, 720, 960, 1280],
    width: 1280,
    height: 801,
    alt: "Créatrice préparant les premières décisions de son entreprise depuis chez elle.",
    focalPosition: "right center",
    intendedRoutes: ["/#parcours"],
  }),
  foundersDiscussionPathway: asset({
    base: `${imageryRoot}/pathways/pathway-founders-discussion`,
    mobileBase: `${imageryRoot}/mobile/pathway-founders-discussion-mobile`,
    widths: [480, 720, 960, 1280],
    width: 1280,
    height: 801,
    alt: "Trois porteurs de projet discutent ensemble de leurs premières décisions.",
    focalPosition: "right center",
    intendedRoutes: ["/#parcours"],
  }),
  artisanActivity: asset({
    base: `${imageryRoot}/activities/activity-artisan-workshop`,
    mobileBase: `${imageryRoot}/mobile/activity-artisan-workshop-mobile`,
    widths: [480, 720, 960, 1280, 1586],
    width: 1586,
    height: 992,
    alt: "Artisan préparant son travail dans son atelier.",
    focalPosition: "right center",
    intendedRoutes: ["/"],
  }),
  localShopActivity: asset({
    base: `${imageryRoot}/activities/activity-local-shop`,
    mobileBase: `${imageryRoot}/mobile/activity-local-shop-mobile`,
    widths: [480, 720, 960, 1280, 1586],
    width: 1586,
    height: 992,
    alt: "Commerçante organisant les produits de son magasin de proximité.",
    focalPosition: "right center",
    intendedRoutes: ["/"],
  }),
  fieldServiceActivity: asset({
    base: `${imageryRoot}/activities/activity-field-service`,
    mobileBase: `${imageryRoot}/mobile/activity-field-service-mobile`,
    widths: [480, 720, 960, 1280, 1586],
    width: 1586,
    height: 992,
    alt: "Professionnelle de service préparant son matériel avant une intervention.",
    focalPosition: "right center",
    intendedRoutes: ["/"],
  }),
  restaurantActivity: asset({
    base: `${imageryRoot}/activities/activity-restaurant-owner`,
    mobileBase: `${imageryRoot}/mobile/activity-restaurant-owner-mobile`,
    widths: [480, 720, 960, 1280, 1586],
    width: 1586,
    height: 992,
    alt: "Restaurateur préparant sa salle avant le service.",
    focalPosition: "right center",
    intendedRoutes: ["/"],
  }),
  logisticsActivity: asset({
    base: `${imageryRoot}/activities/activity-logistics`,
    mobileBase: `${imageryRoot}/mobile/activity-logistics-mobile`,
    widths: [480, 720, 960, 1280, 1586],
    width: 1586,
    height: 992,
    alt: "Professionnel de la logistique préparant une livraison.",
    focalPosition: "right center",
    intendedRoutes: ["/"],
  }),
  projectOrganisation: asset({
    base: `${imageryRoot}/process/process-project-organisation`,
    mobileBase: `${imageryRoot}/mobile/process-project-organisation-mobile`,
    widths: [480, 720, 960, 1280],
    width: 1280,
    height: 801,
    alt: "Documents de travail, carnet et calculatrice organisés sur une table.",
    focalPosition: "center",
