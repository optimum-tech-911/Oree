...
const audiencePaths = [
  ...
  { id: "unknown", icon: Scale, asset: imagery.chooseStatusHero, title: "Je cherche le bon statut", short: "Diagnostic", description: "Obtenez une première recommandation fondée sur votre situation réelle et vos priorités.", href: "/diagnostic", action: "Commencer mon dossier", points: ["Nombre d'associés", "Protection et fiscalité", "Projet de développement"] },
];
